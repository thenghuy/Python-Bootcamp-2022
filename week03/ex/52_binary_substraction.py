def binary_substraction(num1,num2):
    ...
    for i in range(maxlength-1,-1,-1):
           b1=binary_num_1[i]
           b2 = binary_num_2[i]
           if (b1=="0" and b2=="0" and c=="0") or  (b1=="1" and b2=="1" and c=="0") :
             list.append("0")
             c="0"
           elif (b1=="0" and b2=="1" and c=="1"):
               list.append("0")
               c = "1"

           elif (b1=="0" and b2=="1" and c=="0") or(b1=="1" and b2=="1" and c=="1")or (b1=="0" and b2=="0" and c=="1"):
               list.append("1")
               c = "1"
           elif (b1=="1" and b2=="0" and c=="0") :
               list.append("1")
               c = "0"
           elif b1=="1" and b2=="0" and c=="1" :
               list.append("0")
               c = "0"
    if c == "11":
        list.append("1")
    ...
    print("Num1                :  {}\n"
          "Num2                :  {}\n"
          "Difference (Binary) :  {}\n"
          "Difference (Decimal):  {} ".format(binary_num_1, binary_num_2, result.lstrip("0"), num1- num2))
